...
namespace DAL
{
    public class ThongKeDAL: Database
    {
        public DataTable ThongKeTieuThuDien(string ngayBD, string ngayKT)
        {
            ...
            string query = $"SELECT * FROM dbo.Fn_ThongKeTieuThuDien('{ngayBD}','{ngayKT}')";
            MoKetNoi();
        ...
        {
            DataTable dataTable = new DataTable();
            string query = $"SELECT * FROM dbo.Fn_TKChitietDV('{ngayBD}','{ngayKT}')";
            MoKetNoi();
            adapter = new SqlDataAdapter(query, sqlCon);
            adapter.Fill(dataTable);
            DongKetNoi();
        ...
        {
            DataTable dataTable = new DataTable();
            string query = $"SELECT * FROM dbo.Fn_TKDichVu('{ngayBD}','{ngayKT}')";
            MoKetNoi();
            adapter = new SqlDataAdapter(query, sqlCon);
            adapter.Fill(dataTable);
            DongKetNoi();
        ...
        {
            DataTable dataTable = new DataTable();
            string query = $"SELECT * FROM dbo.Fn_TKPhongThue('{ngayBD}','{ngayKT}')";
            MoKetNoi();
            adapter = new SqlDataAdapter(query, sqlCon);
            adapter.Fill(dataTable);
            DongKetNoi();
        ...
        {
            DataTable dataTable = new DataTable();
            string query = $"SELECT * FROM dbo.Fn_TKThuTien('{ngayBD}','{ngayKT}')";
            MoKetNoi();
            adapter = new SqlDataAdapter(query, sqlCon);
            adapter.Fill(dataTable);
            DongKetNoi();
        ...
        {
            DataTable dataTable = new DataTable();
            string query = $"SELECT * FROM dbo.Fn_TKTongHop('{ngayBD}','{ngayKT}')";
            MoKetNoi();
            adapter = new SqlDataAdapter(query, sqlCon);
            adapter.Fill(dataTable);
            DongKetNoi();
