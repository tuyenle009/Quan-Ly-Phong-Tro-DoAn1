...
namespace QuanLyPhongTro_10122399
{
    public partial class frmKhachTro1 : Form
    {
        ...
        public void HienThiDSKT()
        {
            ...
            {
                dgvDSKT.Rows.Add(item.MaKT, item.HoTen, item.GioiTinh, item.SDT, item.CMND, item.NgheNghiep, item.DiaChi);
            }
        }
        ...
        private void dgvDSKT_RowPrePaint(object sender, DataGridViewRowPrePaintEventArgs e)
        {
            ...
            else
            {
                ...
                dgvDSKT.Rows[e.RowIndex].DefaultCellStyle.BackColor = Color.FromArgb(249, 173, 192);
                //255 182 193
            }
        }
