...
namespace QuanLyPhongTro_10122399
{
    public partial class frmDangNhap : Form
    {
        ...
        private void btnDangNhap1_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (modify.lstTaiKhoan(query).Count > 0)//kiem tra list co tk khong
                {
                    ...
                    TaiKhoan.quyenTK = pqbll.ktQuyen(tenTK);
                    this.Hide();
                    frmGiaoDien2 home = new frmGiaoDien2();
                    home.ShowDialog();
                    //this.Close();
                }
                else
        ...
        {
            // Khi nhấn vào Label, chuyển đổi giữa hiển thị và ẩn mật khẩu trong TextBox
            // Chuyển đổi giữa hiển thị và ẩn mật khẩu trong TextBox
            txtMatKhau.PasswordChar = (txtMatKhau.PasswordChar == '\0') ? '*' : '\0';
